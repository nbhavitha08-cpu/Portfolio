    ...
    <section id="about" className="py-24 bg-white">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          ...
          {/* Content */}
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed" style={{ fontFamily: 'Inter, sans-serif' }}>
            <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center p-6 bg-gray-50 rounded-2xl hover:shadow-lg transition-all duration-300 hover:scale-105">
              <h3 className="text-4xl font-bold text-orange-500 mb-2" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                2+
              </h3>
